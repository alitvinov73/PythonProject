...
class Cell:
    ...
    def __sub__(self, other):
        ...
        return f'Вычитание клеток, разность клеток равна: {sub} клеткам' if sub > 0 else 'Клетка удалена'

    def __truediv__(self, other):
        return f'Деление клеток, частное равно {self.quantity // other.quantity}'

    def __mul__(self, other):
        return f'Умножение клеток, произведение клеток равно {self.quantity * other.quantity}'
